...
pub(super) const WORKSPACE_SUMMARY_HEIGHT: u16 = 9;
...
pub(super) const CONNECTION_FORM_FIELD_COUNT: usize = 9;
pub(super) const SQLITE_FILE_PICKER_WIDTH_PERCENT: u16 = 72;
pub(super) const SQLITE_FILE_PICKER_HEIGHT_PERCENT: u16 = 58;
...
pub(super) const HELP_OVERLAY_WIDTH_PERCENT: u16 = 82;
pub(super) const HELP_OVERLAY_HEIGHT_PERCENT: u16 = 92;
pub(super) const INLINE_MODAL_WIDTH_PERCENT: u16 = 70;
pub(super) const INLINE_MODAL_HEIGHT_PERCENT: u16 = 18;
pub(super) const CREATE_TABLE_FORM_WIDTH_PERCENT: u16 = 74;
pub(super) const CREATE_TABLE_FORM_HEIGHT_PERCENT: u16 = 62;
pub(super) const INSERT_ROW_FORM_WIDTH_PERCENT: u16 = 72;
pub(super) const INSERT_ROW_FORM_HEIGHT_PERCENT: u16 = 60;
